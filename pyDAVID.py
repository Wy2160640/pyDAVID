#import urllib2
#exec urllib2.urlopen('http://adamlabadorf.github.io/python/DAVID.py').read()
#exec open('/home/labadorf/development/adamlabadorf.github.io/python/DAVID.py').read()
#DAVID = do_import()
...
class DAVID(object) :
    def __init__(self,ids=None,
        ...
        if load_fn is not None : # load the DAVID analysis from a previously saved file
            ...
            client.service.authenticate('labadorf@bu.edu')
